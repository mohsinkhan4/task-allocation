...
export class MyBinComponent implements OnInit {
    ...
    constructor(private router: Router, private userService: UserService, private taskService: TaskService, private authenticationService: AuthenticationService, public dialog: MatDialog) { }
